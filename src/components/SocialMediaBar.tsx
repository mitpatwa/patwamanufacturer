...
const SocialMediaBar = () => {
  const socialLinks = [
    { icon: Instagram, url: 'https://www.instagram.com/patwa_manufacturer?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==', label: 'Instagram', color: 'hover:text-pink-500' },
