  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="twitter:title" content="Luxury Embellishments Collection | Patwa Manufacturer" />
        <meta name="twitter:description" content="Beaded accents and metallic trims that finish any luxury interior project." />
